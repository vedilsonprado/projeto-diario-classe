...
public class Aluno {
	...
	@JoinColumn(name = "turma_id", nullable = true) // <--- ALTERE PARA TRUE
	@JsonIgnoreProperties({ "alunos", "turmasUcs" }) // Evitar loop se necessário
	private Turma turma;

	// Relacionamento 1:N com LancamentoNota (Um Aluno tem Muitos Lançamentos de
	// Notas)
	@JsonIgnore
